...
CBDBMapper _$CBDocDBMapper() => CBDBMapper(
      'app_doc',
      [
        CBDBColumn(CBDBType.text, CBDoc.idColumnName, pk: true),
...
CBDBMapper _$CBFileDBMapper() => CBDBMapper(
      'app_file',
      [
        CBDBColumn(CBDBType.text, CBFile.idColumnName, pk: true),
...
CBDBMapper _$CBObjectDBMapper() => CBDBMapper(
      'app_object',
      [
        CBDBColumn(CBDBType.text, CBObject.idColumnName, pk: true),
